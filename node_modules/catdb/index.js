...
module.exports = function(name, cb) {
  return new CatDB(name, cb)
}

module.exports.CatDB = CatDB

CatDB.prototype.get = function(id, cb) {
...
CatDB.prototype.put = function(readStream, cb) {
  var me = this
  var data = []
...
CatDB.prototype._store = function(json, cb) {
...
CatDB.prototype._getUniqueTime = function() {
  var time = +new Date()
  while (time === +new Date())
  return +new Date()+""
}